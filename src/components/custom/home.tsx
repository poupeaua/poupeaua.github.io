...
const EMAIL = "alexandre.poupeau.contact@gmail.com";
const linkedin = "https://www.linkedin.com/in/alexandre-poupeau-67a893133/";
const github = "https://github.com/poupeaua";
  ...
  <div className="flex justify-start gap-3 mb-10">
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-8 h-8 text-muted-foreground hover:text-primary transition-colors duration-200"
            >
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-9 h-9 text-muted-foreground hover:text-primary transition-colors duration-200"
            >
