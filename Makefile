...
docker:
	...
	@echo "Deployed on port 8080 so that you can have both the website on the current Hugo version on port 1313 and the latest Hugo version on port 8080 to compare"
